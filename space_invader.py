...
# Score
score_value = 0
font = pygame.font.Font('fonts/Starjedi.ttf', 32)
...
def move_bullet():
    global bulletX, bulletY, bullet_state, bulletX_change, bulletY_change
    # Bullet Movement
    if bulletY <= 0:  #top of the screen
        bulletY = 480  #bottom of the screen
        bullet_state = "ready"
...
def game_input():
    global running, playerX_change, playerX, bulletX
...
def move_enemy():
    global num_of_enemies, enemyX, enemyY, enemyX_change, enemyY_change
    # enemy movement
    for i in range(num_of_enemies):
